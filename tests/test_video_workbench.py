...
def test_video_workbench_is_published_with_its_assets(tmp_path: Path) -> None:
    ...
    for name in ["index.html", "workbench.css", "workbench.js", "metrics.mjs", "models.js", "inference.worker.js", "audio.worker.js", "live.mjs", "overlay-recording.js", "timeline.mjs", "audio.mjs", "observations.mjs", "calibration.js"]:
